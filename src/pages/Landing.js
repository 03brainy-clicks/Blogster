          ...
          <div className="flex gap-5 flex-col mt-16">
            <div className="features-container">
              ...
              <div className="flex-1">
                ...
                <p className="text-gray-500">
                  Blogster does not require the creation of a new email address.
                  Just sign in with your Gmail and we'll do the heavy lifting.
                  Enjoy your newspaper and enjoy your daily activities.
                </p>
              </div>
            ...
            <div className="features-container">
              ...
              <div className="flex-1">
                ...
                <p className="text-gray-500">
                  Everything in Blogster was built with one goal in the mind to
                  create more enjoyable and mindful newsletter reading
            ...
            <div className="features-container">
              ...
              <div className="flex-1">
                ...
                <p className="text-gray-500">
                  Blogster to navigate with Blogflash you can close through your
                  News letter in an easy to read feed notifications from
            ...
            <div className="features-container">
              ...
              <div className="flex-1">
                ...
                <p className="text-gray-500">
                  ...
                  emails. Nothing else. Your data is 100% private and Secure we
                  just sent newspapers and blocks to your mail in one time.
                </p>
              </div>
        ...
        <div className="my-28 " id="works">
          ...
          <div className="flex lg:flex-row flex-col gap-5 mt-16">
            <div className="flex gap-5">
              <div>
                <div className="features-icon flex">
                  <h5 className="text-xl font-bold text-blue-ribbon-600">01</h5>
                </div>
              </div>
              <div>
                <h5 className="text-xl font-bold text-gray-800 ">
            ...
            <div className="flex gap-5">
              <div>
                <div className="features-icon flex ">
                  <h5 className="text-xl font-bold text-blue-ribbon-600">03</h5>
                </div>
              </div>
              <div>
                <h5 className="text-xl font-bold text-gray-800 ">
